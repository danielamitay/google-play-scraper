...
// FIXME this looks similar to the processAndRecur = require( other methods
...
/*
 * Apply MAPPINGS for each application in list = require( root path
*/
